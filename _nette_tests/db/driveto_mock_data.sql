...
INSERT INTO `car` (`id`, `make_id`, `model_id`, `trim_id`, `engine_id`, `list_price`) VALUES
(9, 4, 13, 4, 4, 1004692);
...
INSERT INTO `engine` (`id`, `make_id`, `volume`, `power`) VALUES
(4, 4, '1.20', 81);
...
INSERT INTO `model` (`id`, `make_id`, `name`, `line`) VALUES
(13, 4, 'Fabia', '');
...
INSERT INTO `trim` (`id`, `make_id`, `name`) VALUES
(4, 4, 'Ambition Plus');
